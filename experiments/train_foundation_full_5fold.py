"""Train Foundation Encoder full 5-fold on SGCC."""
import os, sys
...
# Config tuned for RTX 5060 Laptop 8GB
trainer = FoundationTrainer(
    dataset='sgcc_foundation',
    pretrain_epochs=10,
    finetune_epochs=60,
    batch_size=64,
    lr=1e-4,
...
print('\nSaved to', os.path.join(OUTPUT_DIR, 'sgcc_foundation.npz'))
