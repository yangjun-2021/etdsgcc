"""Fast 1-epoch check: targeted synthetic anomalies vs baseline on small AMST."""
import os
import sys
import time
...
base_kwargs = dict(
    ...
    d_mamba=16, d_trans=32, d_freq=16, proj_dim=32,
    n_mamba_layers=1, n_trans_layers=1, n_heads=2, dropout=0.2,
    epochs=3, batch_size=256, lr=1e-4, patience=10, recall_weight=5.0, use_amp=True,
)
