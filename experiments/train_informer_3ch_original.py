"""Train Informer with strong GBDT prior on 3-channel input using ORIGINAL labels.

Usage:
    conda run -n ml python experiments/train_informer_3ch_original.py
...
out_prefix = 'informer_3ch_original'
