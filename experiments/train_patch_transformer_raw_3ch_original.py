"""Train Patch Transformer on raw-scale 3ch input using ORIGINAL labels.

Usage:
    conda run -n ml python experiments/train_patch_transformer_raw_3ch_original.py
...
out_prefix = 'patch_transformer_raw_3ch_original'

# Fast config from raw 3ch screen
CONFIG = {
    'patch_len': 30,
    'stride': 15,
    'd_model': 64,
...
print(f'\n=== Overall Patch Transformer raw 3ch original ===')
...
np.savez_compressed(
    ...
    oof_patch_transformer_raw_3ch_original=oof,
    y_orig=flags,
)
