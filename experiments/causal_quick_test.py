...
def main():
    parser = argparse.ArgumentParser(description='CATE-TST causal quick SGCC experiment')
    ...
    parser.add_argument('--dragonnet-epochs', type=int, default=5)
    parser.add_argument('--batch-size', type=int, default=32)
    parser.add_argument('--d-model', type=int, default=64)
    parser.add_argument('--n-layers', type=int, default=1)
    parser.add_argument('--n-heads', type=int, default=4)
    parser.add_argument('--lstm-hidden', type=int, default=32)
    parser.add_argument('--lstm-pool', type=int, default=8)
    ...
    trainer = CausalTrainer(
        ...
        dragonnet_epochs=args.dragonnet_epochs,
        batch_size=args.batch_size,
        d_model=args.d_model,
        n_layers=args.n_layers,
        n_heads=args.n_heads,
        lstm_hidden=args.lstm_hidden,
        lstm_pool=args.lstm_pool,
        patience=max(3, args.dragonnet_epochs),
    )
