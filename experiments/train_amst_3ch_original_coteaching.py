"""Train AMST-Net on 3-channel input with strong GBDT prior using ORIGINAL labels.

Enables co-teaching inside AMSTTrainer to handle the ~744 label-noise samples.

Usage:
    conda run -n ml python experiments/train_amst_3ch_original_coteaching.py
...
out_prefix = 'amst_3ch_original_coteaching'
...
print(f'\n=== Overall AMST 3ch original coteaching ===')
...
np.savez_compressed(
    ...
    oof_amst_3ch_original_coteaching=oof,
    y_orig=flags,
)
